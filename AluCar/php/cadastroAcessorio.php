...
if($id_acessorio > 0){
    $query_acessorio = "UPDATE acessorio 
    SET nome = :nome, descricao = :descricao, qtd_acessorio = :qtd_acessorio, valor_acessorio = :valor_acessorio, id_locadora = :id_locadora WHERE id_acessorio = :id_acessorio"; 
}else{
